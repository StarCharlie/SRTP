...
<template>
  <div style="height: 700px; background-color: lightblue; text-align: center;">
    <div ref="graph" style="width:90%; height: 600px; margin:auto; top:100px; background-color:whitesmoke;"></div>
  </div>
</template>
